...
@DisplayName("Tests for Going home process (DMN table)")
...
public class ChooseTransportToHomeTest extends AbstractTestBase {
    ...
    public void setUp() {
        ...
        var inputStream = getClass().getClassLoader().getResourceAsStream("dmn/choose-transport-to-home-dmn.dmn");
    ...
    public static Stream<Arguments> clientTransportProvider() {
        return Stream.of(
	       Arguments.arguments(CLIENT_MONEY_0, "walking"),
	       Arguments.arguments(CLIENT_MONEY_9, "walking"),
	       Arguments.arguments(CLIENT_MONEY_10, "walking"),
	       Arguments.arguments(CLIENT_MONEY_10_1, "cityBus"),
